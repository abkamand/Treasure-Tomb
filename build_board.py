...
def build_the_board():
    ...
    description = (
        "After hours of trekking through the dank and dangerous caverns, you finally arrive at the tomb  you've been looking for.\nYou walk into a large chamber, filled with ornate decorations and paintings on the ceiling.\nThere appears to be giant "
        + (Fore.WHITE + "mosaic")
        + "\033[39m"
    ...
    note.add_env_description(
        "On the ground next to the corpse there is a "
        + (Fore.WHITE + "note")
        + "\033[39m"
    ...
    sword.add_env_description(
        ...
        + (Fore.MAGENTA + "sword")
        + "\033[39m"
        + " impaled in the skeleton of the corpse."
    )
    ...
    torch = Item("torch")
    torch.add_description(
        "This is a torch that can be used to illuminate rooms that are dark"
    )
    ...
    painkillers.add_env_description(
        "Looks like there is a bottle of "
        + (Fore.BLUE + "painkillers")
        + "\033[39m"
    ...
    description = (
        "You're in a dim and damp room with white limestone walls surrounding you on all sides. The smell "
        ...
        + (Fore.WHITE + "Carvings")
        + "\033[39m"
        + "adorn the walls of the room, depicting a map of a "
        "large river and several inscriptions. Below the "
        "statue, there is an ornate "
        + (Fore.WHITE + "sink")
        + "\033[39m"
        + "with a faucet in the shape of a waterfall.\nHigh above "
    ...
    description = (
        ...
        "back into the " + (Fore.YELLOW + "Main Chamber") + "\033[39m" + "."
    )
    ...
    chalice.add_env_description(
        "In the sink there is a golden " + (Fore.WHITE + "chalice") + "\033[39m" + "."
    )
    ...
    mummy.add_env_description(
        ...
        + (Fore.RED + "mummy")
        + "\033[39m"
        + "rises from what looks like a sarcophagus. The mummy's dry and "
    ...
    mummy.set_moves_and_power(
        3, "The mummy swings his axe at you, but you manage to dodge him!", 0
    )
    mummy.set_moves_and_power(
        4, "The mummy bashes you on head with the handle of his axe!", 10
    )
