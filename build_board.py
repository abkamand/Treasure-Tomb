...
def build_the_board():
    ...
    description = (
        "This is the room to the east of the Main Chamber.\nIt's very dimly lit.\nThere is an open "
        + (Fore.WHITE + "sarcophagus")
        + "\033[39m"
    ...
    mummy = Enemy("mummy")
    # add description
    mummy.add_description(
        "A terrifying mummy wrapped in cloth.\nIt is very scary and want to eat you"
    )
    ...
    mummy.add_env_description(
        ...
        + (Fore.RED + "mummy")
        + "\033[39m"
        + " is standing in the middle of the room by the sarcophagus.\nIt was probably his.\nHe begins sauntering towards you."
    )
    # set its HP
    mummy.set_HP(100)
    ...
    mummy.set_moves_and_power(
        3, "The mummy swings his dull sword at you, damaging you!", 10
    )
    mummy.set_moves_and_power(
        4, "The mummy bashes you on head with the hilt of his sword!", 10
    )
